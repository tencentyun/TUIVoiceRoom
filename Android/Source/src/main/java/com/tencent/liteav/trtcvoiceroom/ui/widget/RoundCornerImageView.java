...
public class RoundCornerImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLeftTopRadius = array.getDimensionPixelOffset(R.styleable.TRTCVoiceRoomRoundCornerImageView_left_top_radius, mDefaultRadius);
        mRightTopRadius = array.getDimensionPixelOffset(R.styleable.TRTCVoiceRoomRoundCornerImageView_right_top_radius, mDefaultRadius);
        mRightBottomRadius = array.getDimensionPixelOffset(R.styleable.TRTCVoiceRoomRoundCornerImageView_right_bottom_radius, mDefaultRadius);
        mLeftBottomRadius = array.getDimensionPixelOffset(R.styleable.TRTCVoiceRoomRoundCornerImageView_left_bottom_radius, mDefaultRadius);
